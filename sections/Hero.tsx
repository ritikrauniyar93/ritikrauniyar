      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-7xl relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.div variants={heroChild} className="flex flex-wrap items-center gap-4 mb-10">
            ...
            <Link href="/resume.pdf" target="_blank" className="inline-flex items-center justify-center border border-white/10 hover:border-white/20 hover:bg-white/5 rounded-full h-12 px-7 transition-colors">
              Download Resume
            </Link>
          </motion.div>
